        ...
        <div style={S.page} className="lead-generator-page">
            ...
            <div style={S.topHeader} className="lead-generator-header">
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    {canExportCsv && done && results.length > 0 && (
...
const S = {
    ...
    loginCard: { width: "420px", margin: "90px auto", background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "22px", padding: "32px", boxShadow: "0 20px 50px rgba(0,0,0,0.08)", position: "relative", zIndex: 10 },
    loginTitle: { fontSize: "28px", fontWeight: "800", color: "#0f172a", marginTop: "28px", fontFamily: "'Outfit', sans-serif" },
    loginSub: { fontSize: "14px", color: "#64748b", marginTop: "6px" },
    demoBox: { marginTop: "20px", padding: "14px", borderRadius: "12px", background: "#f8fafc", border: "1px solid #e2e8f0", fontSize: "12px", color: "#475569", lineHeight: "1.8" },
    userBadge: { padding: "8px 12px", borderRadius: "999px", background: "#f1f5f9", border: "1px solid #e2e8f0", fontSize: "12px", color: "#334155", fontWeight: "700", textTransform: "capitalize" },
    logoutBtn: { padding: "8px 14px", background: "rgba(239, 68, 68, 0.06)", border: "1px solid rgba(239, 68, 68, 0.18)", borderRadius: "10px", color: "#ef4444", fontWeight: "700", fontSize: "12px", cursor: "pointer" },
